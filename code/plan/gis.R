...
gis_plan <- drake_plan(
  ...
  sau1 = st_read(file_in(here("data/gis/statistical-area-1-2018-clipped-generalised.shp"))),
  sau1db = fastdigest(st_write(sau1, "PG:dbname=ece", "sau1", layer_options = "OVERWRITE=true"))
  )
